    ...
    <footer className="transition-colors duration-500 border-t py-20 pb-10" style={{ backgroundColor: 'var(--bg-primary)', borderColor: 'var(--border-primary)' }}>
      <div className="container-custom px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          {/* Links Sections */}
          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-[0.2em] mb-6" style={{ color: 'var(--text-primary)' }}>Product</h4>
          ...
          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-[0.2em] mb-6" style={{ color: 'var(--text-primary)' }}>Company</h4>
            <ul className="space-y-4">
          ...
          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-[0.2em] mb-6" style={{ color: 'var(--text-primary)' }}>Status</h4>
            <div className="p-4 rounded-2xl border bg-slate-900/5 dark:bg-white/5" style={{ borderColor: 'var(--glass-border)' }}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: 'var(--text-primary)' }}>Network Live</span>
              </div>
