  ...
  return (
    <nav className="fixed top-6 left-0 right-0 z-[100] transition-all duration-500">
      <div className="container-custom flex justify-center">
        <div className={`flex items-center gap-4 transition-all duration-500 rounded-full px-6 py-2 border ${
          scrolled 
          ...
          <div className="flex items-center gap-2">
             ...
             {!isAuthenticated ? (
               <Link href="/login" className="text-[10px] font-bold uppercase tracking-widest text-slate-500 hover:text-slate-900 dark:text-white/60 dark:hover:text-white px-4 py-2 transition-colors">
                  Login
               </Link>
             ) : (
               <div className="flex items-center gap-2">
