...
export default function Footer() {
  ...
  const footerLinks = {
    marketplace: [
      ...
      { name: 'Verify Products', href: '/verify' },
      { name: 'Categories', href: '/categories' },
      { name: 'Recently Registered', href: '/marketplace?sort=newest' },
    ],
    creators: [
      { name: 'Register Trademark', href: '/register' },
    ...
    <>
      ...
      <footer className="bg-gray-50 border-t border-gray-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Creators */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Creators</h3>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">TrademarkChain</p>
